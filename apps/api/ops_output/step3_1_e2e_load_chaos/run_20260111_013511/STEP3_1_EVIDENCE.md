...
- [x] REP corruption = 0
- [x] Stuck runs = 0
- [ ] C1 service_restarted = False (none)
- [x] C2 service_restarted = True (deploymentRestart)
- [ ] C3 service_restarted = False (deploymentRestart)
```

---

*Evidence generated at 2026-01-10T17:35:45.954256+00:00*
...
celery_app = Celery(
    ...
    include=[
        ...
        "app.tasks.pil_tasks",  # PIL: Blueprint orchestration tasks
...
celery_app.conf.task_routes = {
    ...
    # PIL: Blueprint orchestration tasks - using default queue
    "app.tasks.pil_tasks.*": {
        "queue": "default",
        "routing_key": "default",
    },
...
# Trigger redeploy 20260111_053800 - investigate simulation task crash

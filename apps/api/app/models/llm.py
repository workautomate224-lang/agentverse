...
class LLMProfileKey(str, Enum):
    ...
    PIL_GOAL_ANALYSIS = "PIL_GOAL_ANALYSIS"
    PIL_CLARIFYING_QUESTIONS = "PIL_CLARIFYING_QUESTIONS"
    PIL_RISK_ASSESSMENT = "PIL_RISK_ASSESSMENT"
    PIL_BLUEPRINT_GENERATION = "PIL_BLUEPRINT_GENERATION"
    PIL_FINAL_BLUEPRINT_BUILD = "PIL_FINAL_BLUEPRINT_BUILD"  # Slice 2A: Blueprint v2
